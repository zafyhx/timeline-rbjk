...
const GanttChart = () => {
  ...
  const projectData = {
    weeks: [
      {
        ...
        progress: 100,
        tasks: [
          { name: 'Analisis Blueprint', owner: 'PM', duration: '1d', status: 'completed' },
          { name: 'Security Requirements', owner: 'Bagus', duration: '1d', status: 'completed' },
          { name: 'Logical Design + VLAN', owner: 'Alifian', duration: '2d', status: 'completed' },
          { name: 'Physical Design + Cabling', owner: 'Rizal', duration: '2d', status: 'completed' },
          { name: 'Device Selection + BoM', owner: 'Rayhan', duration: '1d', status: 'completed' },
          { name: 'Security Validation', owner: 'Bagus', duration: '0.5d', status: 'completed' },
          { name: 'Budget & Weekly Report', owner: 'Dewi', duration: '1d', status: 'completed' }
        ]
      },
      {
        id: 'week11',
        ...
        tasks: [
          { name: 'Analisis Blueprint', owner: 'PM', duration: '1d', status: 'completed' },
          { name: 'Security Requirements', owner: 'Bagus', duration: '1d', status: 'completed' },
          { name: 'Logical Design', owner: 'Alifian', duration: '2d', status: 'in-progress' },
      ...
      },
      {
        ...
        progress: 0,
        tasks: [
          { name: 'Analisis Blueprint', owner: 'PM', duration: '1d', status: 'pending' },
      ...
      },
      {
        ...
        critical: true,
        tasks: [
          { name: 'Integrasi Semua Area', owner: 'PM + Tim', duration: '3d', status: 'pending' },
      ...
      },
      {
        ...
        critical: true,
        tasks: [
          { name: 'Penyusunan Proposal Final', owner: 'Dewi + PM', duration: '6d', status: 'pending' },
          { name: 'QC & Editing Akhir', owner: 'PM', duration: '1d', status: 'pending' }
        ]
      },
      {
        id: 'week16',
    ...
    teamMembers: [
      { name: 'PM', role: 'Project Manager', color: 'bg-purple-500' },
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg border-2 border-green-200">
              ...
              <div className="text-2xl font-bold text-green-700">1 Week</div>
            </div>
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-4 rounded-lg border-2 border-yellow-200">
              ...
              <div className="text-2xl font-bold text-yellow-700">1 Week</div>
            </div>
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-lg border-2 border-gray-200">
              ...
              <div className="text-2xl font-bold text-gray-700">5 Weeks</div>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border-2 border-blue-200">
              <div className="text-sm text-blue-700 font-medium mb-1">Overall Progress</div>
